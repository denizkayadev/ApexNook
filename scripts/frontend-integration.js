 ...
 * This file demonstrates how to integrate Apexnook with a web frontend
 */

// For React/Vue/Angular applications
export class ApexnookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ApexnookClient(provider, contractAddress);
